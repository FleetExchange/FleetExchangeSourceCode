...
const IMPORTANT_FILES = [
  ...
  {
    key: "transporterTerms",
    label: "Service Terms & Conditions",
    required: true,
    description: "Transport service terms for clients",
    clientVisible: true,
  },
  {
    key: "insurance",
    ...
    required: true,
    description: "Insurance coverage for cargo protection",
    clientVisible: true,
  },
  {
    key: "roadworthy",
    label: "Fleet Roadworthy Certificates",
    required: true,
    description: "Vehicle safety and compliance certificates",
    clientVisible: true,
  },
  {
    key: "professionalLicense",
    label: "Professional Drivers License (PrDP)",
    required: true,
    description: "Commercial driving qualifications",
    clientVisible: true,
  },
  {
    ...
    required: true,
    description: "Authority to operate transport services",
    clientVisible: true,
  },
];
    ...
    <div className="bg-base-100 rounded-2xl shadow-xl border border-base-300 p-6 sm:p-8 mb-6">
      ...
      <div className="space-y-6">
        {IMPORTANT_FILES.map((fileConfig) => {
          ...
          // Hide unverified client-visible docs from non-owners (clients)
          if (
            !isOwner &&
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1 min-w-0 pr-3">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    ...
                    {/* Show "Verified" badge for clients viewing verified docs */}
                    {fileConfig.clientVisible &&
                      !isOwner &&
                      fileInfo.verificationStatus === "approved" && (
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-base-content/70">
                    ...
                    verified. Complete verification to build client trust and
        ...
        <div className="mt-6 bg-info/10 border border-info/20 rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-base-content/70">
                This transporter's business documents have been verified by our
